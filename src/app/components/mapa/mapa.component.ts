...
export class MapaComponent implements OnInit {
  ...
  private imageUrls = [
    ...
    '../../assets/img/escudos/CasdJoseMariaEspinosaPrieto.png',
    '../../assets/img/escudos/celetinomutis.png',
    '../../assets/img/escudos/compartir.png',
    '../../assets/img/escudos/ConcejodeMedellin.png',
    '../../assets/img/escudos/ConcejoMunicipalDeItagui.png',
    '../../assets/img/escudos/Corvide.png',
    '../../assets/img/escudos/EnriqueVelezEscobar.png',
    '../../assets/img/escudos/EstebanOchoa.png',
    '../../assets/img/escudos/FedericoCarrasquilla.png',
    '../../assets/img/escudos/FelixHenaoBotero.png',
    '../../assets/img/escudos/feyalegriavarias.png',
    '../../assets/img/escudos/GilbertoAlzateAvendañocopia.png',
    '../../assets/img/escudos/GonzaloRestrepoJaramillo.png',
    '../../assets/img/escudos/granizada.png',
    '../../assets/img/escudos/granjas.png',
    '../../assets/img/escudos/Guadalupe.png',
    '../../assets/img/escudos/HernanVillaBaenacopia.png',
    '../../assets/img/escudos/icolven.png',
    '../../assets/img/escudos/inem.png',
    '../../assets/img/escudos/javieralondono.png',
    '../../assets/img/escudos/jesusmariaelrosal.png',
    '../../assets/img/escudos/jesusrey.png',
    '../../assets/img/escudos/JohnFKennedy.png',
    '../../assets/img/escudos/JorgeEliecerGaitan.png',
    '../../assets/img/escudos/jorgerobledo.png',
    '../../assets/img/escudos/JoseAcevedoYGomez.png',
    '../../assets/img/escudos/JoseHoracioBetancur.png',
    '../../assets/img/escudos/josemariabernal.png',
    '../../assets/img/escudos/JoseMiguelDeRestrepoYPuerta.png',
    '../../assets/img/escudos/Kennedy.png',
    '../../assets/img/escudos/laesperanza.png',
    '../../assets/img/escudos/LaIndependencia.png',
    '../../assets/img/escudos/LaMilagrosa.png',
    '../../assets/img/escudos/LaMilagrosamedellin.png',
    '../../assets/img/escudos/lourdes.png',
    '../../assets/img/escudos/LucrecioJaramilloVelez.png',
    '../../assets/img/escudos/madrelaura.png',
    '../../assets/img/escudos/ManuelJBetancur.png',
    '../../assets/img/escudos/ManuelJoseCaicedo.png',
    '../../assets/img/escudos/Mari.EPoussepin.png',
    '../../assets/img/escudos/MariaDeLosAngelesCano.png',
    '../../assets/img/escudos/MariaJosefaEscobar.png',
    '../../assets/img/escudos/mariamontesori.png',
    '../../assets/img/escudos/MontecarloGuillermoGaviriaCorrea.png',
    '../../assets/img/escudos/navarra.png',
    '../../assets/img/escudos/nuevohorizonte.png',
    '../../assets/img/escudos/octaviocalderon.png',
    '../../assets/img/escudos/OctavioHarry.png',
    '../../assets/img/escudos/PabloVI.png',
    '../../assets/img/escudos/PaulaMontal.png',
    '../../assets/img/escudos/PedroClaver.png',
    '../../assets/img/escudos/PedroEstrada.png',
    '../../assets/img/escudos/pedrooctavioamado.png',
    '../../assets/img/escudos/Pedro_Luis_Villa.png',
    '../../assets/img/escudos/pequenamaria.png',
    '../../assets/img/escudos/pradito.png',
    '../../assets/img/escudos/PresbiteroAntonioJoseBernal.png',
    '../../assets/img/escudos/PresbiteroBernardoMontoyaGiraldo.png',
    '../../assets/img/escudos/RaquelJaramillo.png',
    '../../assets/img/escudos/ReinodeBelgica.png',
    '../../assets/img/escudos/SagradaFamiliaAldeaPabloVI.png',
    '../../assets/img/escudos/salvador.png',
    '../../assets/img/escudos/SanCristobal.png',
    '../../assets/img/escudos/SanFelix.png',
    '../../assets/img/escudos/SanFranciscoDeAsis.png',
    '../../assets/img/escudos/SanJoseObrero.png',
    '../../assets/img/escudos/sanlorenzo.png',
    '../../assets/img/escudos/SanLuisGonzaga.png',
    '../../assets/img/escudos/SanPablo.png',
    '../../assets/img/escudos/SantaBertillaBoscardin.png',
    '../../assets/img/escudos/santacatalina.png',
    '../../assets/img/escudos/santaleoni.png',
    '../../assets/img/escudos/SoldeOriente.png',
    '../../assets/img/escudos/teresiano.png',
    '../../assets/img/escudos/TomasCadavidRestrepo.png',
    '../../assets/img/escudos/tulioospina.png',
    '../../assets/img/escudos/VidaParaTodos.png',
    '../../assets/img/escudos/villadelsol.png'
  ];
  ...
  private addMarkers(map: L.Map): void {
    const marker = L.marker([6.354233968597593, -75.4983243959306], {
      icon: L.icon({
        iconUrl: '../../assets/img/escudos/PresbiteroBernardoMontoyaGiraldo.png',
        iconSize: [60, 70],
        iconAnchor: [22, 94],
        popupAnchor: [-3, -76],
      })
...
=======
>>>>>>> 42a1e92d3c4707ac7bdc6c2b41555a68915ab336
//Fin
